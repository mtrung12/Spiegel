...
class ActionLogger:
    """
    Action logger, kept for backwards compatibility.
...
# Global logger instance, kept for backwards compatibility
_global_logger: Optional[ActionLogger] = None


def get_logger(log_path: Optional[str] = None) -> ActionLogger:
    """Return the global logger instance (backwards-compatible helper)."""

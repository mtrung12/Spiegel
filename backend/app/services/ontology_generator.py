...
"""
    ...
    def generate_python_code(self, ontology: Dict[str, Any]) -> str:
        """
        Render the ontology definition as Python source (an ontology.py module).
        ...
        code_lines = [
            ...
            'Auto-generated by Spiegel for social opinion simulation.',
            '"""',
            '',
        ...
        # Emit the edge source_targets mapping
